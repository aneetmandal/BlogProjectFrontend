...
class Bollywood extends Component{
    render(){
        return(
            ...
            <div className='B-Bollywood'>Bollywood</div>
            <div className='B-Technology'>Technology</div>
            <div className='B-Hollywood'>Hollywood</div>
            <div className='B-Fitness'>Fitness</div>
            <div className='B-Food'>Food</div>
            ...
            <div className='Bollywood-Section'>
                ...
                <div className='BW5-Pic'></div>
                <div className='BW5-Head'>Catch waves with an adventure guide</div>
                ...
                <div className='BW6-Pic'></div>
                <div className='BW6-Head'>Catch waves with an adventure guide</div>
                ...
                <div className='BW7-Pic'></div>
                <div className='BW7-Head'>Catch waves with an adventure guide</div>
            ...
            <div className='B-Top-Section'>
                ...
                <div className='BTP-1-Pic'></div>
                <div className='BTP-1-Head'>Catch waves with an adventure guide</div>
                ...
                <div className='BTP-2-Pic'></div>
                <div className='BTP-2-Head'>Catch waves with an adventure guide</div>
                ...
                <div className='BTP-3-Pic'></div>
                <div className='BTP-3-Head'>Catch waves with an adventure guide</div>
                ...
                <div className='BTP-4-Pic'></div>
                <div className='BTP-4-Head'>Catch waves with an adventure guide</div>

...
return(
    ...
    <div class="LatestCard-1">
        <div class="Temple-1"></div>
        <div class="Temple-1-Text">Joshua Tree <br /> Overnight Adventure</div>
    ...
    <div class="LatestCard-2">
        <div class="Temple-2"></div>
        <div class="Temple2-2-Text">Joshua Tree <br /> Overnight Adventure</div>
    ...
    <div class="Temple-3"></div>
    <div class="Temple3-Text">Joshua Tree <br /> Overnight Adventure</div>
